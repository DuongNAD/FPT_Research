...
def main():
    malware_dir = project_root / "data" / "quarantine" / "task_advanced"
    prod_quarantine = project_root / "04_Production" / "quarantine"
    os.makedirs(prod_quarantine, exist_ok=True)
    
    report_lines = []
    report_lines.append("# Báo Cáo Chấm Điểm Thử Nghiệm Multi-Agent (Advanced Evasion Mode)")
    ...
    report_file = report_dir / "benchmark_results_advanced.md"
